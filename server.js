...
app.use('/api/writer', authenticateToken, rateLimiters.generation, require('./routes/writer'));
app.use('/api/research', authenticateToken, rateLimiters.generation, require('./routes/research'));
app.use('/api/detector', authenticateToken, rateLimiters.generation, require('./routes/detector'));
app.use('/api/prompt', authenticateToken, rateLimiters.generation, require('./routes/promptEngineer'));
